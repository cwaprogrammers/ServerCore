...
public class CobarSqlMapClientDaoSupportTestWithComposedRuleRouter extends
    ...
    public CobarSqlMapClientDaoSupportTestWithComposedRuleRouter() {
        super(new String[]{"config/root.xml"});
//        super(new String[] { "config/db/spring/db-applicationcontext.xml",
//                "config/db/spring/datasources-applicationcontext.xml",
//                "config/db/spring/router-applicationcontext.xml" });
        
//        super(new String[] { "config/db/spring/cobar-client-appctx.xml",
//                "config/db/spring/datasources-applicationcontext.xml",
//                "config/db/spring/namespace-sqlaction-composed-router-appctx.xml" });
    }
    ...
    public static void main(String args[]){
            CobarSqlMapClientDaoSupportTestWithComposedRuleRouter test=new CobarSqlMapClientDaoSupportTestWithComposedRuleRouter();
            test.testBatchInsertOnDaoSupport();
    }
}
