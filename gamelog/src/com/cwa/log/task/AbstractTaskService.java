...
public abstract class AbstractTaskService {
	...
	public void info(){
		if(logger.isInfoEnabled())
			logger.info("【"+getName()+"】执行线程数量,Core="+getExecutor().getCorePoolSize()+",active="+getExecutor().getActiveCount()+",completeNum="+getExecutor().getCompletedTaskCount()+",taskNum="+handlerList.size());
	}
	/**
	 * 执行停止的方法
	 */
